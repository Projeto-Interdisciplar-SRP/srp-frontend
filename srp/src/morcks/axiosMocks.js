...
mock.onPost('http://localhost:5173/api/../src/componentes/Login.jsx').reply((config) => {
...
mock.onPost('http://localhost:5173/src/componentes/Cadastro.jsx').reply((config) => {
...
mock.onGet('http://localhost:5173/src/componentes/Perfil.jsx').reply((config) => {
